...
- Panjang dan tinggi board untuk area bermain berukuran 100x100 sel yang dimana satu selnya merupakan persegi dengan ukuran dibebaskan, yang penting sama setiap selnya.
...
- Ketika game selesai, score akan ditunjukkan yang dihitung dari jumlah buah yang dimakan.
- Nama main class adalah SnakeGame (Contoh command untuk menjalankan adalah: java SnakeGame).
- Kontrol dari game adalah tombol-tombol panah untuk mengarahkan ular dan spasi untuk memulai game.
